...
at the current folder to install Trilinos and its enabled 
packages. One can make corresponding changes in the file 
cmake-ming_mu-tc-stk-mpi.sh to enable certain trilinos' packages
or successfully install trilinos.--Ming Gong
